...
function App() {
  ...
  const handleFileSelect = async (e) => {
    ...
    if (newFiles.length + uploadedFiles.length > maxFiles) {
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <button 
              ...
              disabled={uploadedFiles.length === 0 || loading || isUploading}
              style={{
                width: '100%',
                padding: '12px',
                backgroundColor: uploadedFiles.length === 0 || loading || isUploading ? '#e5e7eb' : '#3b82f6',
                color: uploadedFiles.length === 0 || loading || isUploading ? '#9ca3af' : 'white',
                border: 'none',
                borderRadius: '6px',
                fontSize: '14px',
